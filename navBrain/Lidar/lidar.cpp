...
Lidar::Lidar(ISerialPort* port, std::function<void (bool startSweep, const LidarData&)> handler, bool autoStartScan)
    : port{port}, handler{handler}, autoStartScan{autoStartScan}
{
