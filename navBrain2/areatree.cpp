...
////        for (int i =0; i < current->containsCellnts.size(); i++)
////        {
...
//            {
//                if(s1.p1.exactlyEquals(s2.p2) && s1.p2.exactlyEquals(s2.p1))
//                {
//                    if(!(s1.p2.exactlyEquals(s2.p1)))
//                    {
//                        cout<<"BAD"<<endl;
//                    }
//                    //cout<<"found one"<<endl;
